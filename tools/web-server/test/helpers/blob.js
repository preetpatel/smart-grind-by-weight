...
export function buildSessionBlob({
    ...
    measurementCount = 5,
    schemaVersion = 2,
    checksum = null, // null → legacy 0; 'crc32' → real CRC of the payload
    targetWeight = 18,
    finalWeight = 18.02,
    ...
    const sessionSize = SESSION_SIZE + eventCount * EVENT_SIZE + measurementCount * MEASUREMENT_SIZE;
    ...
    const statusBytes = new TextEncoder().encode(resultStatus.slice(0, 15));
    bytes.set(statusBytes, s + 64);
