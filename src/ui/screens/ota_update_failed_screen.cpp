...
void OtaUpdateFailedScreen::create() {
    ...
    lv_obj_set_style_text_color(details_label, lv_color_hex(UI_COLOR_DIM), 0);
    ...
    lv_obj_set_style_bg_color(ok_button, lv_color_hex(UI_COLOR_ACCENT), 0);
    ...
    lv_obj_set_style_text_color(ok_button_label, lv_color_hex(UI_COLOR_INK), 0);
